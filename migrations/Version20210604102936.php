 ...
 */
final class Version20210604102936 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE days (id INT AUTO_INCREMENT NOT NULL, tours_id INT DEFAULT NULL, title VARCHAR(500) DEFAULT NULL, description LONGTEXT DEFAULT NULL, hotel LONGTEXT DEFAULT NULL, photo VARCHAR(500) DEFAULT NULL, INDEX IDX_EBE4FC668B14082 (tours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
